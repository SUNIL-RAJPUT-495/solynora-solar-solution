    ...
    <div className="pt-32 min-h-screen bg-slate-50">
      <section className="bg-slate-100 py-24 text-center border-b border-slate-200">
        <div className="container mx-auto px-6">
          <h1 className="text-5xl font-heading font-extrabold text-slate-900 mb-8 tracking-tight">Help Center</h1>
          <div className="max-w-2xl mx-auto relative">
            <input
              type="text"
              placeholder="Search for help..."
              className="w-full px-8 py-5 rounded-2xl bg-white border border-slate-200 text-slate-900 placeholder-slate-400 focus:ring-2 focus:ring-primary outline-none transition-all text-lg shadow-sm"
            />
